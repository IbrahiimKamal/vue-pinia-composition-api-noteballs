    ...
    <div v-for="i in 3" :key="i" class="card mb-4">
      <div class="card-content">
        <div class="content">
          ...
          doloribus cupiditate ipsum nostrum, eligendi inventore incidunt
          aliquam consequatur accusamus quis et deserunt praesentium expedita
          eaque modi fugit repudiandae eius.
        </div>
      </div>
